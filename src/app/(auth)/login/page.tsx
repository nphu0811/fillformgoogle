    ...
    <div className="w-full max-w-md mx-auto animate-fade-in-up">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 sm:p-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 font-medium text-sm">Log in to your account to continue</p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-white px-4 text-slate-400 font-medium">or login with email</span>
          </div>
        </div>
